...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-gray-400 text-primary-content mt-16">
  <aside>
   <img src="https://i.ibb.co/8NKqQBp/techshop-logo.webp" alt="" />
    <p className="font-bold text-white">
      Techno Industries Ltd. <br/>Providing authentic product since 2010.
    </p> 
